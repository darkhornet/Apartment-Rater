...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { address2: @apartment.address2, address: @apartment.address, city: @apartment.city, name: @apartment.name, state: @apartment.state, zip: @apartment.zip }
    end
  ...
  test "should update apartment" do
    put :update, id: @apartment, apartment: { address2: @apartment.address2, address: @apartment.address, city: @apartment.city, name: @apartment.name, state: @apartment.state, zip: @apartment.zip }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
